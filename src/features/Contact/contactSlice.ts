    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(deleteContactsData.fulfilled, (state, action) => {
          ...
          state.contacts = state.contacts.filter((contact) => {return contact._id !== action.payload});
        })
        ...
        .addCase(get1ContactData.fulfilled, (state, action) => {
          ...
          state.contactDetail = state.contacts.filter((contact) => {return contact._id === action.payload});
        })
