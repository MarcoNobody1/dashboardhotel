...
export const detailData = (state: RootState) => state.bookings.bookingDetail;
export const bookingDeleteStatus = (state: RootState) =>
  state.bookings.deleteStatus;
export const bookingIdStatus = (state: RootState) =>
  state.bookings.getBookingStatus;
